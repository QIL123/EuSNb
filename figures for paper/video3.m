...
for i=1:len
    ...
    annotation("doublearrow",[0.85,0.88],[0.19,0.19],'LineWidth',3,'Head1Style','vback1','Head2Style','vback1','Color',anotcolor)
    
    %plot3([12,14],[1,1],[1,1]*max(max(Z)),'Color',anotcolor,'LineWidth',lw);
    text(8.6,-2.5,max(max(Z)),'\mu_0H_y','Color',anotcolor,'FontSize',fontsize)
    %plot AC colorbar
...
xlabel(transport1,'\mu_0H_y (mT)','FontSize',fontsize);
